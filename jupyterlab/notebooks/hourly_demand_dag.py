...
from energy import _get_hourly_demand
...
# define the DAG
dag = DAG(
    'get_hourly_demand_v1',
    default_args=default_args,
    description='Queries Cammesa API to get electricity demand for the actual date. Inserts or update hourly information into Postgres DB',
    ...
    #schedule_interval='*/10 * * * *' # Every ten minutes ---timedelta(days=1),
)
